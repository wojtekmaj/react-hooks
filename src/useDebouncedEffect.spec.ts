...
describe('useDebouncedEffect()', () => {
  it('should call effect after debounce time on mount', () => {
    const fn = vi.fn();
  ...
  it('should call effect after debounce time on dependency change', () => {
    const fn = vi.fn();
  ...
  it('should cancel and re-run effect on dependency change', () => {
    const cleanup = vi.fn();
